        ...
        children: [
            {
                ...
                path: '/music/classicalList',//古典音乐列表
                name: 'classicalList',
                component: () => import('pages/classicalList/classicalList'),
                meta: {
                    keepAlive: true
                }
            }, {
                path: '/music/familyList',//名族音乐列表
                component: () => import('pages/familyList/familyList'),
                meta: {
                    keepAlive: true
                }
            }, {
